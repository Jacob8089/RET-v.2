...
def new_win():
  # w.destroy()
    ...
    q.iconbitmap(path+"\\RETV2_icon.ico")
...
#hourly report tab_"每小时报告"选项卡
    ...
    img_tab1= ImageTk.PhotoImage(Image.open(path+"/RETV2_h1.png"))
    img_lab=Label(tab1, image=img_tab1, width=150, height=150, borderwidth=0)
    img_lab.place(x=40, y=70)

    tab1_l2=Label(tab1,text='Welcome,',fg='black',bg='white',font="Calibri 11")
...
#minutely throughput tab_分钟吞吐量选项卡
    ...
    tab2_b2= Button(tab2, text="Import File", command=lambda:threading.Thread(target=open_file_mint).start(), font="Calibri 8 bold", width=15, bg=a, fg="white",borderwidth=0, relief=GROOVE)
    ...
    tab2_b1=Button(tab2, text="Enter", command=lambda:gen(),font="Calibri 7 bold", width=7, bg="white", fg=a)
    tab2_b1.place(x=290,y=10)
    tab2_b1=Button(tab2, text="Reset", command=lambda:res(), font="Calibri 7 bold", width=7, bg="red", fg="white")
    tab2_b1.place(x=340,y=10)
    ...
    tab3_l2=Label(tab2, text='', fg='black',bg="white", font="Calibri 6 ")
    ...
    my_notebook.add(tab3,text= "Chute Conc.")
...
l4=Label(w,text='V 2.0',fg='white',bg=a)
lst4=('Calibri (Body)',10)
l4.config(font=lst4)
l4.place(x=50,y=150)
